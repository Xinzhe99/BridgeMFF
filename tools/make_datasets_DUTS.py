...
def Ramdom_GaussianBlur(input):
    blur_levels = [(3,3),(5, 5), (7, 7), (9, 9), (11, 11),(13,13),(15,15),(17,17),(19,19),(21,21)]  # 不同的模糊级别，每个元素是一个元组，包含了高斯核的大小
...
if __name__ == "__main__":
    ...
    parser.add_argument('--out_dir_name', type=str, default='DUTS_MFF_NEW')
