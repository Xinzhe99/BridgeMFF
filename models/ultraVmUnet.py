...
class UltraLight_VM_UNet_G(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=1, c_list=[8, 16, 24, 32, 48, 64],
        ...
        self.encoder1 = nn.Sequential(
            nn.Conv2d(input_channels*2, c_list[0], 3, stride=1, padding=1),
        )
        ...
        #self.final = CoordGate(enc_channels=c_list[0], out_channels=num_classes, size=[128, 128], enctype='pos',encoding_layers=1)
...
class UltraLight_VM_UNet_D(nn.Module):
